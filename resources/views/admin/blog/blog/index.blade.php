 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <div class="card content-header" style="padding: 10px;">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 class="m-0 text-dark">Blog post</h3>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header bg-success">
          <h4 class="modal-title" id="exampleModalLabel">Blog Insert</h4>
        ...
        <div class="modal-body">
         <form action="{{ route('store.blog') }}" method="post" id="add_form">
          @csrf
            <div class="form-group">
              <label for="exampleInputEmail1">Select BlogCategory<span class="text-danger">*</span></label>
             ...
             <div class="form-group">
              ...
              <input type="text" class="form-control" id="exampleInputEmail1" name="title" required placeholder="Blog title">
            </div>
            <div class="form-group">
  ...
  <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header bg-success">
          <h4 class="modal-title" id="exampleModalLabel">Blog Post Update</h4>
          <button type="button" class="btn-close" style="border:none; background: none;" data-bs-dismiss="modal" aria-label="Close"><i class="fa-solid fa-xmark text-white"></i></button>
        </div>
  ...
  <script>
    ...
    $('body').on('click','.edit',function(){
      var id=$(this).data('id');
      var url="{{ url('admin/blog/edit') }}/"+id;
      $.ajax({
        url:url,
        type:'get',
        success:function(data){
