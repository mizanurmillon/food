<form action="{{ route('update.leavetype') }}" method="post" id="edit_form">
  @csrf
  <input type="hidden" name="id" value="{{ $data->id }}">
  <div class="form-group">
    <label for="type_name">Type Name<span class="text-danger">*</span></label>
    <input type="text" class="form-control" id="type_name" name="type_name" required value="{{ $data->type_name }}">
  </div>
  <div class="form-group">
    <label for="days">Leave Days<span class="text-danger">*</span></label>
    <input type="text" class="form-control" id="days" name="leave_day" required value="{{ $data->leave_day }}">
  </div>
