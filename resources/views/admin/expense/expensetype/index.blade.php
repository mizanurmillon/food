 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <div class="card content-header" style="padding: 10px;">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 class="m-0 text-dark">Expense Type</h3>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('expensetype') }}">ExpenseType</a></li>
              <li class="breadcrumb-item active">All ExpenseType</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="card">
          <div class="card-header bg-dark">
            ...
            <h3 class="card-title">ExpenseType List</h3>
          </div>
            <!-- /.card-header -->
            <div class="card-body">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-success">
          <h4 class="modal-title" id="exampleModalLabel">ExpenseType Insert</h4>
        ...
        <div class="modal-body">
         <form method="post" action="{{ route('store.expensetype') }}" id="add_form">
          @csrf
            <div class="form-group">
              <label for="exampleInputEmail1">Expense Type name<span class="text-danger">*</span></label>
              <input type="text" class="form-control" id="exampleInputEmail1" name="type_name" required>
            </div>
  ...
  <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-success">
          <h4 class="modal-title" id="exampleModalLabel">ExpenseType Update</h4>
          <button type="button" class="btn-close" style="border:none; background: none;" data-bs-dismiss="modal" aria-label="Close"><i class="fa-solid fa-xmark text-white"></i></button>
        </div>
  ...
  <script type="text/javascript">
    ...
    $('body').on('click','.edit',function(){
      var id=$(this).data('id');
      var url="{{ url('admin/expensetype/edit') }}/"+id;
      $.ajax({
        url:url,
        type:'get',
        success:function(data){
