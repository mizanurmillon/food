  ...
  <div class="content-wrapper">
    ...
    <div class="card content-header" style="padding: 10px;">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 class="m-0 text-dark">Reservation</h3>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="card">
          ...
          <div class="ml-2 mr-2 mt-4">
            <div class="row">
              <div class="col-4">
                <input type="date" class="form-control submitable" name="r_date" id="date">
              </div>
              <div class="col-4">
                <select class="form-control submitable" name="r_month" id="month">
              ...
              <div class="col-4">
                <select class="form-control submitable" name="status" id="status">
                  <option value="">All</option>
                  <option value="Approved" class="text-info">Approved</option>
