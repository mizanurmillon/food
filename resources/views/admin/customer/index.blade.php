 ...
 <!-- Content Wrapper. Contains page content -->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-success">
          <h4 class="modal-title" id="exampleModalLabel">Customer Insert</h4>
        ...
        <div class="modal-body">
         <form method="post" action="{{ route('store.customer') }}" id="add_form">
          @csrf
            ...
            <div class="form-group">
              <label for="password">Customer Password<span class="text-danger">*</span></label>
              <input type="text" class="form-control" id="password" name="password" required value="12345678">
            </div>
  ...
  <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-success">
          <h4 class="modal-title" id="exampleModalLabel">Customer Update</h4>
          <button type="button" class="btn-close" style="border:none; background: none;" data-bs-dismiss="modal" aria-label="Close"><i class="fa-solid fa-xmark text-white"></i></button>
        </div>
  ...
  <script type="text/javascript">
    ...
    //active user request send
    $('body').on('click','.active',function(){
      var id=$(this).data('id');
      var url="{{ url('admin/customer/active') }}/"+id;
      $.ajax({
        url:url,
        type:'get',
        success:function(data){
